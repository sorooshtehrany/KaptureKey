...
#include "..\Include\sdcard_fat.h"		/* Petit FatFs configurations and declarations */
#include "..\Include\sdcard_low.h"		/* Declarations of low level disk I/O functions */
...
)
{
    ...
    if (buff) {
        ...
        res = 0;
          ...
          MSD_SendCmd(MSD_WRITE_BLOCK, sc * 512, 0xFF);
